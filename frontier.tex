...
decide, and in particular it separates the successors of six of the seven
controlled vertices of the game $G^{\ast}$ on which the primal--dual
bracket of \Cref{def:bracket} together with every sound order-theoretic
derivation separates none. Nevertheless the decision rule ``return a
