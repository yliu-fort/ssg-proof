...
$|B|=1$ escapes it, on a game that is reduced and normal, and it escapes
measurably --- on the normalised ladders $N'(L_n)$, $n=2,\dots,6$, the
rule that tries every single $c$ and keeps the best takes $1,2,2,2,3$
rounds where all-switches and the residue rule both take $n$.
