...
`960317f` batch I (handicap zero and the one-player ceiling); `bf3889e` batch H
(abstract and summary). The paper stands at 229 pages with no undefined
references; the PDF is synced to gdrive:ssg-proof/.
